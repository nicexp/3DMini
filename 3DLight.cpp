...
static RGBAV1 ambient = { 200, 200, 200, 0 };	//环境光强度
static RGBAV1 infinite_diffuse = { 255, 255, 255, 0 }; //直射光散射强度
...
static VECTOR4D point_pos = { 400, 1400, 0, 1 }; //点光源位置
...
void InitAllLight(LIGHTV1_PTR lights)
{
	...
	ResetLights(lights);
	//初始化环境光
	InitLight(lights, LIGHT_AMBIENT, LIGHTV1_STATE_ON, LIGHTV1_ATTR_AMBIENT, ambient, invalid_light, invalid_light, NULL, NULL, 0, 0, 0, 0, 0, 0);
	//初始化直射光
	InitLight(lights, LIGHT_INFINITE, LIGHTV1_STATE_ON, LIGHTV1_ATTR_INFINITE, invalid_light, infinite_diffuse, invalid_light, NULL, &infinite_dir, 0, 0, 0, 0, 0, 0);
	//初始化点光源
	InitLight(lights, LIGHT_POINT, LIGHTV1_STATE_OFF, LIGHTV1_ATTR_POINT, invalid_light, point_diffuse, invalid_light, &point_pos, NULL, 0, 0.001, 0, 0, 0, 0);
	//初始化聚光灯
	InitLight(lights, LIGHT_SPOT, LIGHTV1_STATE_OFF, LIGHTV1_ATTR_SPOTLIGHT2, invalid_light, spot_diffuse, invalid_light, &spot_pos, &spot_dir, 0, 0.001, 0, 0, 0, 1);
}
